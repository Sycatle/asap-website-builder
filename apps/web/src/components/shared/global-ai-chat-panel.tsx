 ...
 */
const ThinkingIndicator = React.memo(function ThinkingIndicator({ thought, step }: { thought: string; step?: number }) {
  return (
 ...
 * Memoized to prevent re-renders during token streaming
 */
const ChainOfThoughtsDisplay = React.memo(function ChainOfThoughtsDisplay({ steps, isStreaming }: { steps: ChainStep[]; isStreaming?: boolean }) {
