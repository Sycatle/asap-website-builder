...
fn github_sync_module() -> ModuleDefinition {
    ModuleDefinition {
        ...
        description: "Synchronise vos projets GitHub pour les afficher sur votre portfolio".to_string(),
...
fn blog_engine_module() -> ModuleDefinition {
    ModuleDefinition {
        ...
        name: "Blog".to_string(),
        version: "1.0.0".to_string(),
        description: "Créez et gérez un blog sur votre portfolio".to_string(),
...
fn contact_form_module() -> ModuleDefinition {
    ModuleDefinition {
        ...
        version: "1.0.0".to_string(),
        description: "Ajoutez un formulaire de contact à votre portfolio".to_string(),
...
fn analytics_tracker_module() -> ModuleDefinition {
    ModuleDefinition {
        ...
        version: "1.0.0".to_string(),
        description: "Suivez les visites et interactions sur votre portfolio".to_string(),
...
fn theme_engine_module() -> ModuleDefinition {
    ModuleDefinition {
        ...
        version: "1.0.0".to_string(),
        description: "Personnalisez l'apparence de votre portfolio".to_string(),
