...
pub fn create_router(pool: PgPool, config: SharedConfig) -> Router {
    ...
    let authenticated_routes = Router::new()
        ...
        .route("/payments/balance", get(crate::payments::get_balance))
        .route("/payments/payment-intent", post(crate::payments::create_payment_intent))
        .route("/payments/transactions", get(crate::payments::get_transactions))
    ...
    let public_routes = Router::new()
        ...
        .route("/payments/webhook", post(crate::payments::stripe_webhook))
