...
pub async fn create_router_with_ws(
    ...
    let authenticated_routes = Router::new()
        ...
        .route("/account/extensions", get(crate::store::list_installed_extensions))
        .route("/account/extensions/:slug", get(crate::store::get_installed_extension))
        .route("/account/extensions/:slug/install", post(crate::store::install_account_extension))
        .route("/account/extensions/:slug", delete(crate::store::uninstall_account_extension))
        .route("/account/extensions/:slug/settings", patch(crate::store::update_installed_extension_settings))
        .route("/account/extensions/:slug/toggle", patch(crate::store::toggle_installed_extension))
        // Extension Store - Website Extensions v2 (activate/deactivate)
        .route("/websites/:id/extensions/v2", get(crate::store::list_website_extensions))
        .route("/websites/:id/extensions/v2/:slug/activate", post(crate::store::activate_extension_on_website))
